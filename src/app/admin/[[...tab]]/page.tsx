...
const VALID_TABS = ['general', 'health', 'embedding', 'reranking', 'gpu', 'roletypes', 'roleassign', 'hostprov', 'ocr', 'localai', 'aikeys', 'aiservices', 'workers', 'redis', 'cache', 'filings', 'jobs', 'actionlog', 'drafts'] as const;
