...
echo ""
echo "Next: commit this release (sideCar/package.json is bumped), then publish it"
echo "to the public mirror github.com/Project-SandStar/SideCar as tag v$NEW_VERSION:"
echo "  ./scripts/publishSidecarGithub.sh"
